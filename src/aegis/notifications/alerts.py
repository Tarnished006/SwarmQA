"""
src/aegis/notifications/alerts.py — Autonomous Human-In-The-Loop (HITL) Alerting Dispatcher for Project Aegis.
...
logger = logging.getLogger("aegis.notifications.alerts")
...
async def dispatch_hitl_alert(
    ...
    1. Webhook (Slack / Discord / Teams) if ALERT_WEBHOOK_URL is configured.
