...
try:
    from aegis.core.state import Selector, SupervisorDecision
    from aegis.agents.recon import site_analyser_agent, codebase_checker, triage_agent
    from aegis.agents.red_team import active_tester_agent
    from aegis.agents.blue_team import fixing_agent, checker_agent, sandbox_execution_node
    from aegis.agents.deploy import deploy_agent
except ImportError:
...
if "SupervisorDecision" not in globals():
